...
//       <div className="px-[120px] mx-auto ">
//         <header className="Testimonials-module--Testimonials_header--YBbnm">
//           <h2 className="text-center text-[30px] font-semibold leading-[41px] mx-auto mb-4 max-w-[475px] ">
//             Built for today’s ambitious businesses
//           </h2>
//           <p className="text-[#060809] max-w-[650px] mx-auto text-center text-[18px] font-[500] tracking-[-0.2px] leading-[26px]">
...
//             very easy to navigate and it’s obvious they have the best interests
//             of SMEs at heart. I’m proud to call them my bank.”
//           </h3>
...
//             <span className="Testimonials-module--Testimonials_content_indicator--FSkc2"></span>
//           </div>
//           <div className="Testimonials-module--Testimonials_content_logo--ZEJAI">
//             <img
//               src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAIoAAABwCAYAAADBjugbAAAACXBIWXMAABYlAAAWJQFJUiTwAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAABcPSURBVHgB7Z0Lc..."
//               alt="Logo"
//             />
//           </div>
//         </div>
...
//           <img
//             src="/static/feranmi-nifries-82cce619334c31103e84d81b82ce43e1.png"
//             alt="Feranmi Ajetunmobi, Ni-Fries"
//           />
//         </div>
//       </div>
//     </section>
