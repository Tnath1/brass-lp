...
const Team = () => {
  return (
    <section className="py-[6.25rem] mx-auto w-full">
      <div>
        <div className=" lg:min-h-[720px]  grid gap-[3rem_1.875rem] lg:grid-cols-12 grid-cols-1  mr-[calc(50%-626px)] max-w-fit pl-0 w-full ">
          <div className="lg:col-start-1 lg:col-span-7 sticky top-20">
          ...
          <header className="lg:col-start-8 lg:col-span-6 m-auto my-0 max-w-[584px] w-full">
            <div className="max-w-[584px] md:px-0 px-[16px] w-full">
              <span className="text-[#8f96a3] text-xs font-semibold tracking-[-0.12px] leading-[22px]">
                SUPPORT WHEN YOU NEED IT
              </span>
              <h2 className="lg:text-[45px]  text-[30px] font-semibold tracking-[-1.21px] lg:leading-[58px] leading-[35px] mb-4 mt-5">
                <span>
                  Our support team is
                  <br className="text-break block" /> your team
                </span>
              </h2>
              <p className="max-w-[585px] text-[#060809] lg:text-[18px] text-[15px]  font-[500] tracking-[-0.2px] leading-[26px]">
